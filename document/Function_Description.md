...
self.word2ind: {str: int}
	The dictionary of index corresponding to words
...
"""
	The method is used to split sentence into token and upate the dictionary
	self.word2count
	...
	Attributes
	----------
...
"""
	The method is used to utilise the torch.nn.Embedding to generate word 	embeddings
"""

def set_word_vector(self, word_vector)
"""
	The method is used to value the self.word_vector
	...
	Attributes
	----------
	word_vector: torch
...
"""
	The method is used to select the word embeddinds of sentence and set whether 
	freeze the pre-trained word embedding or not
	...
	Attributes
	----------
	freeze: bool
...
"""
	Only select the words which appear to exceed the set value in the file and 	get their word embeddings
	...
	Attributes
	----------
	threshold: int
...
"""
	Return word_embedding function
	...
	Returns
	----------
	self.word_embeddings: nn
